...
public class Register extends JFrame {
	...
	public void registerUser() {
		...
		saleRegister = new ArrayList<>();
		if (cb0.isSelected()) {
			String check0 = refineNumber(cb0.getText());
			saleRegister.add(check0);
		}
		if (cb1.isSelected()) {
			String check0 = refineNumber(cb1.getText());
			saleRegister.add(check0);
		}
		if (cb2.isSelected()) {
			String check0 = refineNumber(cb2.getText());
			saleRegister.add(check0);
		}
		if (cb3.isSelected()) {
			String check0 = refineNumber(cb3.getText());
			saleRegister.add(check0);
		}
		if (cb4.isSelected()) {
			String check0 = refineNumber(cb4.getText());
			saleRegister.add(check0);
		}
		if (cb5.isSelected()) {
			String check0 = refineNumber(cb5.getText());
			saleRegister.add(check0);
		}
		if (cb6.isSelected()) {
			String check0 = refineNumber(cb6.getText());
			saleRegister.add(check0);
		}
		if (cb7.isSelected()) {
			String check0 = refineNumber(cb7.getText());
			saleRegister.add(check0);
		}
		if (cb8.isSelected()) {
			String check0 = refineNumber(cb8.getText());
			saleRegister.add(check0);
		}
		if (cb9.isSelected()) {
			String check0 = refineNumber(cb9.getText());
			saleRegister.add(check0);
		}
		if (cb10.isSelected()) {
			String check0 = refineNumber(cb10.getText());
			saleRegister.add(check0);
		}
		if (cb11.isSelected()) {
			String check0 = refineNumber(cb11.getText());
			saleRegister.add(check0);
		}
		if (cb12.isSelected()) {
			String check0 = refineNumber(cb12.getText());
			saleRegister.add(check0);
		}
		if (cb13.isSelected()) {
			String check0 = refineNumber(cb13.getText());
			saleRegister.add(check0);
		}
		if (cb14.isSelected()) {
			String check0 = refineNumber(cb14.getText());
			saleRegister.add(check0);
		}
		if (cb15.isSelected()) {
			String check0 = refineNumber(cb15.getText());
			saleRegister.add(check0);
		}
		if (cb16.isSelected()) {
			String check0 = refineNumber(cb16.getText());
			saleRegister.add(check0);
		}
		if (cb17.isSelected()) {
			String check0 = refineNumber(cb17.getText());
			saleRegister.add(check0);
		}
		if (cb18.isSelected()) {
			String check0 = refineNumber(cb18.getText());
			saleRegister.add(check0);
		}
		if (cb19.isSelected()) {
			String check0 = refineNumber(cb19.getText());
			saleRegister.add(check0);
		}
		if (cb20.isSelected()) {
			String check0 = refineNumber(cb20.getText());
			saleRegister.add(check0);
		}
		if (cb21.isSelected()) {
			String check0 = refineNumber(cb21.getText());
			saleRegister.add(check0);
		}
		if (cb22.isSelected()) {
			String check0 = refineNumber(cb22.getText());
			saleRegister.add(check0);
		}
		if (cb23.isSelected()) {
			String check0 = refineNumber(cb23.getText());
			saleRegister.add(check0);
		}
		if (cb24.isSelected()) {
			String check0 = refineNumber(cb24.getText());
			saleRegister.add(check0);
		}
		if (cb25.isSelected()) {
			String check0 = refineNumber(cb25.getText());
			saleRegister.add(check0);
		}
		if (cb26.isSelected()) {
			String check0 = refineNumber(cb26.getText());
			saleRegister.add(check0);
		}
		if (cb27.isSelected()) {
			String check0 = refineNumber(cb27.getText());
			saleRegister.add(check0);
		}
		if (cb28.isSelected()) {
			String check0 = refineNumber(cb28.getText());
			saleRegister.add(check0);
		}
		if (cb29.isSelected()) {
			String check0 = refineNumber(cb29.getText());
			saleRegister.add(check0);
		}
		if (cb30.isSelected()) {
			String check0 = refineNumber(cb30.getText());
			saleRegister.add(check0);
		}
		if (cb31.isSelected()) {
			String check0 = refineNumber(cb31.getText());
			saleRegister.add(check0);
		}
		
		User usr = new User(usrName, birthday, id, password, saleRegister);
		
		cm.userRegistration(usr);
	}
